...
interface EditGroupProps {
  group: { id: number; name: string; declaration_text: string } | null
...
export default function EditGroup({ group, onOpenChange }: EditGroupProps) {
  const t = useTranslations("Applications.editGroupDialog")
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    setSubmitError(null)
    try {
      await fetchJson(`/api/admin/applications/groups/${group.id}`, {
        method: "PATCH",
